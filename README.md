...
Vlt is a TUI for Hashicorp Vault. The goal is to support as many functionalities as possible in order to make the tool as useful as possible.   
...
If anyone decides to use this and wants to request a specific feature or even fix a bug - [please open an issue](https://github.com/janosmiko/vlt/issues/new/choose). :smile:
